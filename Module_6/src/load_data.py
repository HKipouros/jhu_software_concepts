...
def get_db_connection():
    ...
    if "DATABASE_URL" not in os.environ:
        ...
        print(f"\n📁 Looking for .env file at: {env_path.resolve()}")
        print(f"   .env file exists: {env_path.exists()}")
        print("\n💡 To fix this:")
        print("   1. Make sure you have a .env file in the project root directory")
        print("   2. Copy .env.example to .env:  copy .env.example .env")
        print("   3. Edit .env and set your DATABASE_URL")
        print("   4. Example: DATABASE_URL=postgresql://postgres:password@localhost:5432/gradcafe_db")
        sys.exit(1)
...
if __name__ == "__main__":
    ...
    INPUT_FILE = script_dir / "llm_extend_applicant_data.json"
