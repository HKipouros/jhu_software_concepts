...
def run_queries():
    ...
    with conn.cursor() as cur:
        ...
        query_results["4"] = (q_4, round(average_gpa_american, 2) if average_gpa_american else None)
        ...
        query_results["6"] = (q_6, round(average_gpa_accepted_f25, 2) if average_gpa_accepted_f25 else None)
